...
public class MusicActivity1 extends AppCompatActivity implements View.OnClickListener{
    ...
    //按钮
    private Button play,pause,con,pre,next,exit;
    //歌曲图片
    private ImageView musicImage;

    private int change=0;//记录下标变化
    private int i;
    public String[] MusicName={"Eastrover,R7CKY - 4U(IDIOIT Remix)","灰澈 - 无根尾系","灰澈 - 星茶会"};
    ...
    private void init(){
        ...
        pre=findViewById(R.id.per);
        pre.setOnClickListener(this);
        next=findViewById(R.id.next);
        next.setOnClickListener(this);
        musicImage=findViewById(R.id.iv_music);
...
//                this.startActivity(intent);
            ...
            case R.id.per://播放上一首
                if((i+change)<1) {
                    ...
                    musicImage.setImageResource(frag1.icons[i+change]);
